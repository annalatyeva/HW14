...
const myFirstArray = ['Привет!', 101, true, 2015, 'лягушонок', false, '95a'];
console.log(myFirstArray);

//Задание 2
//Создайте массив mySecondArray, заполните его любыми значениями. Выведите длину массива.
const mySecondArray = ['коты', false, 465, 'любят', 'пицца', 700, '', true];
...
const myInformation = ['Анна', 11, 'октябрь', 'Весы'];
...
console.log(countriesCopy.shift());
...
let anotherCities = ['Санкт-Петербург', 'Москва', 'Екатеринбург',]
let russianCities = [...anotherCities, 'Казань', 'Нижний Новгород'];
...
function sortAndPrint () {
    ...
    randomNumbersCopy.sort((a, b) => a - b);
